...
const mainFlow = [
	...
	},
	{
		she: {
			...
			modules: text(
				'This is an experiment… a collection of fragments strung together. working title: „on the wrong side of the river bank“'
			)
		}
	},
	{
		...
		she: {
			...
			modules: [
				...
				},
				{
					type: 'circleText',
					content: [
						'None of us had any Christmas decoration,',
						"(maybe that's  something to inherit and not to buy)",
						'so each of us chose a sailor moon character, and we printed different images of them to hang them on the tree.'
					]
				}
			]
		}
		...
		she: {
			...
			modules: [
				...
				},
				{
					type: 'circleText',
					content: [
						'If you don’t know him, he is kind of the German Henry Kissinger.',
						'Or maybe even the European one.',
						'This brought back memories of the 2010 European debt crisis.',
						'Where Schäuble was deeply involved in the austerity measurements / punishment of Greece',
						'resulting in the sellout of Greek infrastructure to German and international companies to the enrichment of Germany.'
					]
				}
			]
		}
		...
		he: {
			...
			onMount() {
				createPopup(
					'/singles/text',
					{
						txt: '»ein Land der Nichtstuer und Korrupteure«,<br> "a country of do-nothings and corruptors"'
					},
					randomPos(40, 10)
				);
				createPopup(
					'/singles/text',
					{
						txt: 'jetzt müsse endlich »Schluss sein mit der Schummelei«;<br> Now "the cheating must finally come to an end"'
					},
					randomPos(40, 10)
				);
				createPopup(
					'/singles/text',
					{
						txt: '»diese Griechen« seien pleite, aber Milliarden-Bettler«. <br> "these Greeks" are broke, but "beggars worth billions"'
					},
					randomPos(40, 10)
				);
				createPopup(
					'/singles/text',
					{
						txt: 'Man dürfe jetzt »keineswegs die Faulheit der Griechen unterstützen«; <br> One should now "by no means support the laziness of the Greeks"'
					},
					randomPos(40, 15)
				);
				createPopup(
					'/singles/text',
					{
						txt: 'schließlich sei »Griechenland im Grunde ein orientalisches Land«, <br> After all, "Greece is basically an oriental country"'
					},
					randomPos(45, 10)
				);
				createPopup(
					'/singles/text',
					{
						txt: 'in Hellas herrschten »orientalische Lebensgesetze«. <br> Hellas is governed by "oriental laws of life"'
					},
					randomPos(40, 10)
				);
			},
			...
			modules: [
				{
					type: 'text',
					content:
						'A boy puts his hand around my wist and calls it a girls’ ankle. <br><br> I did not rebut.<br>I was confused. <br><br>How should I know that being “girly” was a bad thing?'
				}
			]
		}
	},
			...
			modules: [
				{
					type: 'circleText',
					content: [
						' Turns out, I was also wearing the wrong kind of underwear.',
						'Probably the start of the conflict.',
						'Mine were called Sackkneifer – ball-pincher',
						'in contrast to boxer shorts, obviously the correct kind of underwear.'
					]
				},
				{
					type: 'bgImg',
		...
		she: {
			...
			modules: [
				...
				},
				{
					type: 'text',
					content:
						'But that difference is always defined for us in terms of absence of neurotypicality not as an equal, different being.'
				}
			]
		}
	},
			...
			modules: [
				{
					type: 'text',
					content:
						'The Anthropologist Mary Catherine Watson writing about power relations in Colonialism observed:'
				},
				{
					type: 'text',
					content:
						'“People who don’t wear shoes learn the language of people who do, not vice versa”'
				},
				{
					type: 'circleText',
					content: [
						'These words resonate with me from an autistic perspective. ',
						'No,',
						'don’t ask me to „put myself in your shoes“ when you don’t even think I can wear them.'
					]
				}
			]
		}
	...
	},
	{
		...
		she: {
			...
			pos: percent(20, 60, 30, 60),
			modules: text(
				'Some guy coming into my room while I was sleeping and putting something in my eyes just felt like a relationship I wasn’t interested in.'
			)
		}
	},
	{
		...
		she: {
				...
				for (let row = 0; row < maxRows; row++) {
					...
					for (let column = 0; column < maxCols; column++) {
						...
						createPopup(
							'/singles/sunflower',
							{ num: number },
							posGrid(maxRows, maxCols, row, column),
							`sunflower${number}`
						);
					}
				}
			...
			modules: [
				...
				},
				{
					type: 'text',
					content:
						'But in the worst case, you just have a little snack in the morning and a way to spend some time. Eating sunflower seed is also a kind of stimming.'
				}
			]
		}
	},
			...
			modules: [
				{
					...
					class: 'big',
					content:
						'And at the same time I’m certainly interested in these “live” performance moments <br><br> (also thinking about the transcription tool for the pub launch ) <br><br>I’m more interested in the process itself and not what’s there in the end. '
				}
			]
		}
	},
